...
public class FullFlowE2ETests : IClassFixture<E2ETestFixture>, IAsyncLifetime
{
	...
	public FullFlowE2ETests(E2ETestFixture fixture)
	{
		...
		_testRepoOwner = Environment.GetEnvironmentVariable("E2E_GITHUB_TEST_REPO_OWNER") ?? "neovim";
		_testRepoName = Environment.GetEnvironmentVariable("E2E_GITHUB_TEST_REPO_NAME") ?? "neovim";
	}
